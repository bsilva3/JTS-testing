...
public class MorphingMckerney {
    ...
    public static Coordinate[] morphingMckerney (String geometry1, String geometry2, int beginTime, int endTime, int queryTime){
        StringBuilder output = new StringBuilder();
        String sep = System.getProperty("file.separator");
        ProcessBuilder pb = new ProcessBuilder("python","pyspatiotemporalgeom" + sep + "mckerney.py", geometry1, geometry2, beginTime+"", endTime+"", queryTime+"");
        try {
            Process p = pb.start();
        ...
        try{
            ...
            return listSegmentToCoordinateList(coords);
     ...
     * method makes sure all connections are aligned so that the geometry is properly drawn.
