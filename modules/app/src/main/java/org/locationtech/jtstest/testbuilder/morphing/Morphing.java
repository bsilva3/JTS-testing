...
import jni_st_mesh.MorphingMckerney;
...
public class Morphing {
    ...
    public Morphing(String geometry1, String geometry2, double beginTime, double endTime, MorphingMethod morphingMethod) {
     ...
     * @return 
     */
    public String morphingAtInstant(double queryTime, String selectedType, int triangulationMethod, boolean cw, double threshold){
        String result = "";
        //load c++ libraries
        ...
        if(selectedType.equals(AppStrings.POLY_STRING)){
            result = m.at_instant_poly(1000.0, 2000.0, geometry1, geometry2, 
                    queryTime, triangulationMethod, cw, threshold);
        }
        //mesh, at instant
        else if(selectedType.equals(AppStrings.MESH_STRING)){
            result = m.at_instant_mesh(1000.0, 2000.0, geometry1, geometry2, 
                    queryTime, triangulationMethod, cw, threshold);
        }
        return result;
    }
     ...
     * @return 
     */
    public String morphingAtInstantPoly(double queryTime, int triangulationMethod, boolean cw, double threshold){
        String result = "";
        //load c++ libraries
        System.loadLibrary(AppStrings.DLL_LIBRARY);
        Main m = new Main();
     ...
     * @return 
     */
    public String morphingAtInstantMesh(double queryTime, int triangulationMethod, boolean cw, double threshold){
        String result = "";
        //load c++ libraries
        System.loadLibrary(AppStrings.DLL_LIBRARY);
        Main m = new Main();
     ...
     * @return 
     */
    public String morphingMckerney (double queryTime){
    ...
    public static Coordinate[] listSegmentToCoordinateList(String listSegment){
        ...
        //List<Coordinate> listOfSegments = new ArrayList<>();
        ...
        Coordinate[] coordsList = new Coordinate[coords.size()];
        coordsList = coords.toArray(coordsList);*/
        return coordsOrdered;
    }
    
    public static String listSegmentToWKT(String listSegment){
