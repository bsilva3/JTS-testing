/*
$Header: /cvs/secondo/Optimizer/MemoryAllocation/ma_improvedcosts.pl,v 1.7 2014/07/04 09:17:59 behr Exp $
...
cost(mergejoin(X, Y, A3, A4), Sel, Pred, MT, ResAttrList, ResTupleSize, 
  ...
  StreamXC=[ResCardX, MemSizeX, AttrsCountX],
	StreamYC=[ResCardY, MemSizeY, AttrsCountY],
  opCosts(MT, NewTerm, [StreamXC, StreamYC], Sel, ResAttrList, OpCostsInMS, 
		NewTerm2),
